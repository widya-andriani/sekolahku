...
import 'package:sekolahku/res/string_res.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget _determineFirstPage() {
    final userService = AppService.userService;
    return FutureBuilder(
        future: userService.isLoggedIn(),
        builder: (c,s) {
          final loggedIn = s.data;
          if(loggedIn != null) {
            if(loggedIn) {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: ColorRes.red),
        useMaterial3: true,
      ),
      home: _determineFirstPage(),
